            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        months: ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "September", "Octobre", "Novembre", "Decembre"],
                        monthsShort: ["Jan", "Fév", "Mar", "Avr", "Mai", "Jui", "Juil", "Au", "Sep", "Oct", "Nov", "Déc"]
                    },
                    tl: {
    ...
    EvoCalendar.prototype.buildCalendar = function (val, new_month, new_year) {
        ...
        function buildEventListHTML() {
            if (_.options.calendarEvents != null) {
                ...
                ;
                if (!hasEventToday) {
                    eventHTML += '<p>La chance, pas d\'événement prévu aujourd\'hui ! Profitez-en pour vous reposez ! </p>';
                }
                eventHTML += '</div>';
...
myEvents = [
    {name: "Nouvelle année", date: "Wed Jan 01 2020 00:00:00 GMT-0800 (Pacific Standard Time)", type: "holiday", everyYear: true},
    {name: 'Anniversaire de Vhierry Aka "Le Patron" ;)', date: "February / 3 / 2020", type: "birthday"},
    {name: 'Journée de Grâce du personnel', date: "February / 15 / 2020", type: "holiday"},
    {name: 'Invitation École Paul-Bert', date: "March / 25 / 2020", type: "event"},
    {name: 'Journée "Coulisses-Ouvertes"', date: "April / 19 / 2020", type: "event"},
    {name: 'Journée du Patrimoine Local', date: "May/5/2020", type: "event"},
    {name: 'Fête des Gibbons', date: "June / 19 / 2020", type: "event"},
    {name: 'Journée du Parrainage', date: "July / 24 / 2020", type: "event"},
    {name: 'Collaboration Zoo de Beauval', date: "August / 27 / 2020", type: "event"},
    {name: "Rentrée du Zoo", date: "September/4/2020", type: "event"},
    {name: "Halloween Disii et D'ailleurs", date: "October/31/2020", type: "event"},
    {name: "Anniversaire Inauguration ZooDisii", date: "November/18/2020", type: "birthday", everyYear: true},
    {name: "Noël du personnel", date: "December/18/2020", type: "event"}
],
